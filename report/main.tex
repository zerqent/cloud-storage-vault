...
control} of the files stored.

%TODO: Elaborate on this.
This could be implemented in \ac{CSV} as either an extension of the items in
the directories, or as a special kind of mutable file. The containing items of
this file could refer to different storage indexes, and have an alias

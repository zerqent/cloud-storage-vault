...
For the other primitives we follow the recommendation. For a cryptographic hash
function this means double \ac{SHA}-256 and for the \ac{MAC} function this
means H\ac{MAC}-\ac{SHA}-256.

...
% etc
% TODO
For \textbf{files} we measure the bandwidth the client get when uploading and
...
hashing of a file. For folders we recorded the time it takes to create and
update a folder with different amount of children to understand how this will
scale.

\textbf{Folders} are relatively small in size, so the network should not be a
bottleneck. However the different cryptographic operations might take some
time. For folders we therefore measured:

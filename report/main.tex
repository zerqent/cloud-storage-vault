...
With 1000 iterations in \emph{PBKDF2} we were able to achieve a brute force efficiency around 1800 passwords
per second for a single computer, and

With 1000 iterations in \emph{PBKDF2} we were able to achieve a brute force
efficiency around 35 000 passwords per second running the
...
Section \ref{sec:BFLK}. The paragraph below will discuss our findings from
Section \ref{sec:R:BFLK}.

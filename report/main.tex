...
retrieving the file from disk, a proper \ac{HTTP} response is returned, containing
required headers.
...
\lstinputlisting[breaklines=false,label=lst:IM:get, caption=URL mapping in fileserver.py]

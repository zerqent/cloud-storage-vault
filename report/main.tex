...
The use of the \ac{MAC} function in \ac{CSV} is somewhat special.
\citet{schneier} defines a \ac{MAC} to be a construction that detects tampering
with a message -- i.e. it authenticates the message.  As depicted in Figure
\ref{fig:CS:CD}, the result of the \ac{MAC} function is another key. By
presenting this key, a user verifies \emph{to the server} that he knows the
write key.

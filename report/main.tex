...
described in Section \ref{ch:CS}. The influence of Tahoe-\ac{LAFS} is described
in detail, followed by subsections scrutinizing how the scheme does or does not
support various features and functionality.

\subsection{Influence of Tahoe-LAFS}
% Capabilities, folders, immutable vs. mutable, some of the key gen.
% Tahoe does not let you change crypto primitives

\subsection{Sharing}
% Read/write keys, integrity, the general key distribution problem

\subsection{Deletion of Files}
% VCS, write-enabler, creator/ACL, link count, DAG

...
\emph{Forgot password} feature, which means that Dropbox can read the users files if
they really want to. Their \ac{FAQ} does however say that some people have been
successful in putting truecrypt containers in Dropbox which efficiently makes

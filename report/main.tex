...
\ac{PBKDF2}. As previously described, \ac{PBKDF2} utilize a password set by the
user to generate the encryption key. Due to the known fact that users are bad at
choosing long and random passwords, this will probably make the derived
encryption key weaker than the keys used for files and folders.

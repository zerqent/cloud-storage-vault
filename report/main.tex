...
%
The source of our client is logically separated into two entities; csv-client
and CSVAndroid. Csv-client is a pure Java library which contain the necessary
functionality for cryptographic operations and server communication while
CSVAndroid contains the Android specific code, in general mostly the User
Interface. 
...
and both upload and download through {\bf PUT} and {\bf GET} requests respectively.

\subsubsection{Cryptographic Entities}

\paragraph{Capabilities}
% TODO: API for Capabiltiies
The implementation of Capabilities lives in csv-client and contains expose the
API presented in Table XX. From a functional standpoint the Capability is in
essence just a Container for encryption keys, and an identifier to locate the

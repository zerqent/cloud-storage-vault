...
Telematics (ITEM). The report is a final result from a Master thesis in
information security written by three graduate students at NTNU. The thesis was
assigned by Earnst \& Young AS Norway, and acknowledged by ITEM.

We would like to thank our external supervisors Carsten Maartmann-Moe and
Antonio Martiradonna, at Earnst \& Young AS, for their valuable contributions.
We would also like to thank Danilo Gligorosky at the Department of Telematics
for providing constructive feedback on the report and for giving us the
opportunity to write this thesis. In addition we would like to thank all

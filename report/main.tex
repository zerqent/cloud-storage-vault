...
A \emph{\ac{CSPRNG}} deterministically produce numbers based on a seed, with
properties making it suitable for use in cryptography.  It should be infeasible
to determine the next number without knowing the seed \cite[p. 140]{schneier}.
